...
m.set([1, 2, 3], "리얼리?");
m.get([1, 2, 3]);
// undefined // [1, 2, 3] != [1, 2, 3] // 다른 배열입니다.
...
// Map과 Object의 차이
// Map 객체와 Object는 둘 다 key - value 관계를 가진다는 점에서 비슷해보이지만 몇 가지 중요한 차이점이 있습니다.
// 1. Object의 키는 문자열 타입으로만 지정해야하지만, Map의 키는 모든 값을 가질 수 있습니다.
// 2. Object는 크기를 사용자가 직접 수동으로 알아내야 하지만, Map은 size를 통해 크기를 쉽게 얻을 수 있습니다.
objMap = new Map();
objMap.set("one", 1);
objMap.set("two", 2);
objMap.set("three", 3);
